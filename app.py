...
def main():
    ...
    if query and submit_button:
        ...
        for line in lines:
            print ("line1",line)
             # Adjust the sleep duration for desired speed
            
        # Display the full line using Markdown
            st.markdown(line, unsafe_allow_html=True)
            time.sleep(1)
        st.markdown(f''' :red[References: ] :blue[{pdf_reference}] ''')
        st.markdown("""  """)
        st.markdown(f'''  :blue[Job Description generated by this tool may require further manual tuning from Buisness Perspective]''')
